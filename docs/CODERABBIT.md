...
**draft PRs are skipped** — a review starts only when the PR is marked
**Ready for review**. Every push to a reviewed PR starts a new incremental
round covering the commits since the last review.
